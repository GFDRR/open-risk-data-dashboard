# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-05 17:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.CharField(max_length=16, unique=True)),
                ('tags', models.ManyToManyField(to='ordd_api.KeyTag')),
            ],
        ),
        migrations.CreateModel(
            name='OptIn',
        ...
        migrations.AddField(
            model_name='keydataset',
            name='description',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ordd_api.KeyDescription'),
        ),
        migrations.AddField(
            model_name='keydataset',
            name='level',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ordd_api.KeyScale'),
        ),
        migrations.AddField(
            model_name='keydataset',
            name='tag_available',
        ...
        migrations.AlterUniqueTogether(
            name='keydataset',
            unique_together=set([('category', 'code'), ('category', 'dataset', 'description', 'level')]),
        ),
    ]
