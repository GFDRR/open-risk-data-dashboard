# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-29 12:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='dataset',
            name='is_avail_for_free_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
            name='is_avail_online_meta_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
            name='is_avail_online_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
            name='is_bulk_avail_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
            name='is_digital_form_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
        ...
        migrations.AddField(
            model_name='dataset',
            name='is_prov_timely_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
        migrations.AddField(
            model_name='dataset',
            name='is_pub_available_txt',
            field=models.CharField(blank=True, max_length=256),
        ),
